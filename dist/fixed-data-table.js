...
/***/ function(module, exports, __webpack_require__) {
	...
	var FixedDataTable = React.createClass({
	  ...
	  getViewportHeightFromProps: function getViewportHeightFromProps( /*object*/props) /*number*/{
	    var totalHeight = props.height === undefined ? props.maxHeight : props.height;

	    if (props.ownerHeight) {
	      totalHeight = Math.min(props.ownerHeight, totalHeight);
	    }

	    var viewportHeight = totalHeight - (props.headerHeight || 0) - (props.footerHeight || 0) - (props.groupHeaderHeight || 0);
	  ...
	  _calculateState: function _calculateState( /*object*/props, /*?object*/oldState) /*object*/{
	    ...
	    if (this._rowToScrollTo !== undefined) {
	      var doRowScroll = function doRowScroll() {
	        scrollState = _this._scrollHelper.scrollRowIntoView(_this._rowToScrollTo);
	        firstRowIndex = scrollState.index;
	        firstRowOffset = scrollState.offset;
	        scrollY = scrollState.position;
	        delete _this._rowToScrollTo;
	      };

	      if (this.props.beforeScroll) {
	        var res = this.props.beforeScroll(scrollX, scrollX, scrollY, this._scrollHelper.getScrollRowIntoViewPosition(this._rowToScrollTo));
	        if (res) {
	          doRowScroll();
	        } else {
	...
	var HorizontalScrollbar = React.createClass({
	  ...
	  render: function render() /*object*/{
	    ...
	    translateDOMPositionXY(innerContainerStyle, 0, this.props.offset, this._initialRender);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FixedDataTableScrollHelper = (function () {
	  ...
	  _createClass(FixedDataTableScrollHelper, [{
	    ...
	    key: 'getScrollRowIntoViewPosition',
	    value: function getScrollRowIntoViewPosition( /*number*/rowIndex) /*object*/{
